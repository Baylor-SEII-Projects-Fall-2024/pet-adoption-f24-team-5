...
public class EventController {
    ...
    public ResponseEntity<?> updateEvent(@PathVariable Long id, @RequestBody Event updatedEvent) {
        if (id == null) {
            return ResponseEntity.badRequest().body("Cannot update event: event ID is null");
        }
        if (updatedEvent == null) {
            return ResponseEntity.badRequest().body("Cannot update event: event is null");
        }
    ...
    public ResponseEntity<?> deleteEvent(@PathVariable Long id) {
        if (id == null) {
            return ResponseEntity.badRequest().body("Cannot delete event: event ID is null");
        }
        try {
