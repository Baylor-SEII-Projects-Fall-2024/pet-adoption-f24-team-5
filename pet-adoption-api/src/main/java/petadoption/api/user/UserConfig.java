...
public class UserConfig {
        @Bean
        CommandLineRunner commandLineRunner(AuthenticationController authenticationController,
                        CenterWorkerRepository centerWorkerRepository, OwnerRepository ownerRepository,
                        AdoptionCenterRepository adoptionCenterRepository, UserRepository userRepository) {
                return args -> {
