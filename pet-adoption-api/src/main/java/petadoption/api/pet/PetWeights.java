...
//import petadoption.api.recommendationEngine.RecommendationEngineController;
//import petadoption.api.recommendationEngine.RecommendationService;
import petadoption.api.user.User;

@Data
@Entity
@Table(name = PetWeights.TABLE_NAME)
@AllArgsConstructor
@RequiredArgsConstructor
public class PetWeights {

    public static final String TABLE_NAME = "Pets_weights";


    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "PET_WEIGHT_ID")
    protected Long petWeightId;
    ...
    public PetWeights(double[] weights) {
        weight1 = weights[0];
        weight2 = weights[1];
        weight3 = weights[2];
        weight4 = weights[3];
    ...
    public void setPreferenceWeightId(Long petWeightId) {
